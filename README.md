...
- Layout: «Legg til i Chrome» er en gullknapp øverst ved flaggene (skjult på mobil), stjernen for å følge butikk står ved butikksøket, alt om tallene (merknader, forbehold, kilder, signatur) ligger bak «Om tallene» i bunnen, og under 560 px vises programmene som rader i billetten i stedet for kolonner.
